...
const ingredientsUsed = recipeData?.ingredientsUsed || "";
...
<div>
  <h1 className="text-4xl md:text-5xl font-bold text-stone-900 tracking-tight ">What Can I Cook?</h1>
          ...
          {recipeData  !== undefined && (
            <div className="bg-orange-50 p-4 border-2 border-orange-200 inline-flex items-center gap-3">
              ...
              <div className="text-sm">
                {recipeData .recommendationsLimit === "unlimited" ? (
                  <>
...
<div className="mt-8 text-center">
  <Button onClick={()=> fetchSuggestions (new FormData())}
   variant="outline" className="bordeer-2 border-stone-900 hover:bg-stone-900 hover:text-white gap-2" disabled={loading}
  >
{loading ? (
  <>
  ...
  Get New Suggestions
   ...
   {/* Empty Pantry State */}
        {!loading && recipes.length === 0 && recipeData ?.success === false && (
